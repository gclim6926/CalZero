// 장치 타입별 SVG 아이콘
const robotIcons = {
  so101_follower: (className = "w-5 h-5") => (
  ...
  so101_leader: (className = "w-5 h-5") => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const robotTypeLabels = {
  so101_follower: 'SO101 Follower',
  so101_leader: 'SO101 Leader',
  alice_m1: 'Alice M1',
  robo1: 'Robo1',
  robo2: 'Robo2',
  isaac_sim: 'Isaac Sim',
...
export const defaultDeviceTypes = [
  { value: 'so101_follower', label: 'SO101 Follower Arm' },
  { value: 'so101_leader', label: 'SO101 Leader Arm' },
  { value: 'alice_m1', label: 'Alice M1' },
  { value: 'robo1', label: 'Robo1' },
  { value: 'robo2', label: 'Robo2' },
